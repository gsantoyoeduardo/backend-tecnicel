-- ============================================
-- TecniCel - TODAS LAS MIGRACIONES + SEED
...
-- ============================================
-- TABLAS BASE (roles, permisos, usuarios)
-- ============================================
...
UNION ALL SELECT c.id, 'Liberacion de patron/contrasena', 'Desbloqueo de pantalla de bloqueo', 25, 30, true, true, true
FROM categorias_servicio c WHERE c.nombre = 'Software'
...
-- Sucursal
INSERT INTO sucursales (nombre, direccion, telefono, email, estado) VALUES
  ('TecniCel - Sede Principal', 'Av. Principal 123, Lima, Peru', '(01) 234-5678', 'info@tecnicel.com', 'activo')
ON CONFLICT DO NOTHING;

-- Admin (password: admin123)
INSERT INTO usuarios (email, password_hash, nombre, apellido, telefono, rol_id, estado)
SELECT 'admin@tecnicel.com', '$2a$10$JstHsz5Tgu.31Epkp9J75eS/g2rg4uDlqA76ZqC4LQlheTcNhxiGO', 'Admin', 'TecniCel', '999111222', r.id, 'activo'
FROM roles r WHERE r.nombre = 'administrador'
ON CONFLICT (email) DO UPDATE SET password_hash = '$2a$10$JstHsz5Tgu.31Epkp9J75eS/g2rg4uDlqA76ZqC4LQlheTcNhxiGO';

-- Recepcionista (password: recepcion123)
INSERT INTO usuarios (email, password_hash, nombre, apellido, telefono, rol_id, estado)
SELECT 'recepcion@tecnicel.com', '$2a$10$z9fTo9Y8ptpZBkBr85pKqeucqalnvHnL/YmR.XctljerBIQrwLA7G', 'Maria', 'Garcia', '999222333', r.id, 'activo'
FROM roles r WHERE r.nombre = 'recepcionista'
ON CONFLICT (email) DO UPDATE SET password_hash = '$2a$10$z9fTo9Y8ptpZBkBr85pKqeucqalnvHnL/YmR.XctljerBIQrwLA7G';

-- Tecnico 1 (password: tecnico123)
INSERT INTO usuarios (email, password_hash, nombre, apellido, telefono, rol_id, estado)
SELECT 'tecnico@tecnicel.com', '$2a$10$JDltOV7pV7cSZW2P5E0N5Ok/rcqzQ1Z5NoNa7j.KgASZXwWpD1FXW', 'Carlos', 'Rodriguez', '999333444', r.id, 'activo'
FROM roles r WHERE r.nombre = 'tecnico'
ON CONFLICT (email) DO UPDATE SET password_hash = '$2a$10$JDltOV7pV7cSZW2P5E0N5Ok/rcqzQ1Z5NoNa7j.KgASZXwWpD1FXW';

-- Tecnico 2 (password: tecnico123)
INSERT INTO usuarios (email, password_hash, nombre, apellido, telefono, rol_id, estado)
SELECT 'tecnico2@tecnicel.com', '$2a$10$JDltOV7pV7cSZW2P5E0N5Ok/rcqzQ1Z5NoNa7j.KgASZXwWpD1FXW', 'Jose', 'Martinez', '999444555', r.id, 'activo'
FROM roles r WHERE r.nombre = 'tecnico'
ON CONFLICT (email) DO UPDATE SET password_hash = '$2a$10$JDltOV7pV7cSZW2P5E0N5Ok/rcqzQ1Z5NoNa7j.KgASZXwWpD1FXW';
